...
public static boolean checkIfServerIsRunnning(int port) {
	...
	public static AndroidDriver<AndroidElement> Capabilities(String appName) throws IOException, InterruptedException{
		...
		//System.getProperty("user.dir"); use this in below path to get path dynamically
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\global.properties");
		
		Properties prop = new Properties();
		prop.load(fis);
		
		//appName is provided in global properties to give app details 
		File appDir = new File("src");
		File app = new File(appDir,(String) prop.get(appName));
		
		DesiredCapabilities cap = new DesiredCapabilities();
		
		//add device from global properties
		String device = (String) prop.get("device");
		//add device from maven use below code
	...
	public static void getScreenshot(String s) throws IOException{
		//cast driver into TakesScreenshot
